...
- DFS ` *** ` - [CF - 1006E](https://codeforces.com/contest/1006/problem/E)
- DFS ` *** ` - [AC - abc239_e](https://atcoder.jp/contests/abc239/tasks/abc239_e)
...
- DFS ` **** ` - [AC - abc240_e](https://atcoder.jp/contests/abc240/tasks/abc240_e)
...
- BFS ` *** ` - [CF - 1176E](https://codeforces.com/contest/1176/problem/E)
...
- DFS or BFS ` *** ` - [CF - 1624G](https://codeforces.com/contest/1624/problem/G)
- DFS or BFS (Complement Graph Transversal) ` **** ` - [CF - 190E](https://codeforces.com/contest/190/problem/E)
- DFS or BFS (Complement Graph Transversal) ` **** ` - [CF - 920E](https://codeforces.com/contest/920/problem/E)
