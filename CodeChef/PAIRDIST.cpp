...
void Solution() {
    ...
    V<int> a(n);
    fo(i, n) cin >> a[i];
    //! only 4 points on 4 axis with equal manhattan distance
    /*
    1. Answer is not possible for N>4
    2. For N<=4, we choose one point on each of the axes (+X,−X,+Y,−Y+X, -X, +Y, -Y+X,−X,+Y,−Y). 
    The final ans can be 
    *((A0,0),(−A1,0),(0,A2),(0,−A3))
    */
