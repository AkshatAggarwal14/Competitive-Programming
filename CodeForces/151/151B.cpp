...
void solve()
{
    ...
    fo(i, n)
    {
        ...
        fo(j, a[i])
        {
            ...
            if (S[0] == S[3] && S[6] == S[3] && S[1] == S[4] && S[4] == S[7] && S[0] == S[1])
                countTaxi++;
        ...
        // cout << countTaxi << " " << countPhone << " " << countGirl;
        if (MaxCountGirl < countGirl)
        {
            MaxCountGirl = countGirl;
            Girl.clear(); //like initialising Girl vector for every n
            Girl.pb(s[i]);
        }
