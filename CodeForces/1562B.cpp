...
// void fill() {
//     for (ll i = 2; i < 100; ++i) {
//         if (!isPrime(i)) vv.eb(to_string(i));
//     }
// }

// vector<str> vv = {"1", "4", "6", "8", "9", "12", "14", "15", "16", "18", "21", "22", "24", "25", "26", "27", "28", "32", "33", "34", "35", "36", "38", "39", "42", "44", "45", "46", "48", "49", "51", "52", "54", "55", "56", "57", "58", "62", "63", "64", "65", "66", "68", "69", "72", "74", "75", "76", "77", "78", "81", "82", "84", "85", "86", "87", "88", "91", "92", "93", "94", "95", "96", "98", "99"};

vector<str> vv = {"1", "4", "6", "8", "9", "12", "15", "21", "22", "25", "27", "32", "33", "35", "51", "52", "55", "57", "72", "75", "77"};

bool checkSubseq(str s, str s1) {
    //check s1 is a subseq of s
    ll n = sz(s1);
    ll pos = 0;
    fo(i, sz(s)) {
        if (s[i] == s1[pos]) {
...
void Solution() {
    ...
    // dbg(vv);
    fo(i, sz(vv)) {
        if (checkSubseq(s, vv[i])) {
            cout << sz(vv[i]) << ln << vv[i] << ln;
            return;
        }
    }
}
