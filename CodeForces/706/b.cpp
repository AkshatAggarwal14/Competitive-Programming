...
void solve()
{
    ...
    fo(i, q)
    {
        ...
        // while (low != high)
        // {
        //     ll mid = low + (high - low) / 2; //to avoid int overflow
        ...
        // Here upper_bound returns a pointer to the element that is greater than the target, and arr is pointer to first element, subtracting gives the distance
