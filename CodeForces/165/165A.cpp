...
void solve() {
    ...
    //     ll r = 0, l = 0, u = 0, d = 0;
    //     fo(j, n) {
    //         if (pt[j].ff > pt[i].ff && pt[j].ss == pt[i].ss) r = 1;
    //         if (pt[j].ff < pt[i].ff && pt[j].ss == pt[i].ss) l = 1;
    //         if (pt[j].ff == pt[i].ff && pt[j].ss > pt[i].ss) u = 1;
    //         if (pt[j].ff == pt[i].ff && pt[j].ss < pt[i].ss) d = 1;
    //     }
    //     if (r + l + u + d == 4) cnt++;
    // }
    // cout << cnt;
